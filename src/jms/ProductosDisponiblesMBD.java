...
public class ProductosDisponiblesMBD implements MessageListener, ExceptionListener  
{
	...
	public ProductosDisponiblesMBD(TopicConnectionFactory factory, InitialContext ctx) throws JMSException, NamingException 
	{	
		...
		try 
		{
			...
			if(!ex.getSender().equals(APP))
			{
				if(ex.getStatus().equals(REQUEST))
				{
					...
					ListaProductos videos = dtm.getLocalProductosDisponibles();
